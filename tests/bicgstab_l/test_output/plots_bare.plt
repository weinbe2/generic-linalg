...
plot "./unit_detail_bicgstab.dat" using 1:3 ls 1 w l title "BiCGStab, :UNIT0: sec", "./unit_detail_bicgstab1.dat" using 1:3 ls 2 w l title "BiCGStab-1, :UNIT1: sec", "./unit_detail_bicgstab2.dat" using 1:3 ls 3 w l title "BiCGStab-2, :UNIT2: sec", "./unit_detail_bicgstab4.dat" using 1:3 ls 4 w l title "BiCGStab-4, :UNIT4: sec", "./unit_detail_bicgstab8.dat" using 1:3 ls 5 w l title "BiCGStab-8, :UNIT8: sec", "./unit_detail_bicgstab16.dat" using 1:3 ls 11 w l title "BiCGStab-16, :UNIT16: sec"
set output
