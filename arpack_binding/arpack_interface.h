...
typedef struct
{
   ...
   // Vectors.
   complex<double>* v; // 2d array of size [ldv][maxncv]. Holds eigenvectors.
   complex<double>* d; // 1d array of size [maxncv]. Holds eigenvalues.
   complex<double>* workl; // 1d array of size 3*maxncv**2
				  // + 5*maxncv.
                  // Workspace. Size suggested by znsimp.f.
   complex<double>* workd; // 1d array of size 3*maxn.
                  // This space gets used in reverse feedback to
                  // hold rhs = A*lhs.
   complex<double>* resid; // 1d array of size maxn.
                  // This holds internal residual vectors.       
                  // This is normally zero at the start, but it
                  // can be set to non-zero to choose an initial
                  // guess vector.
   complex<double>* workev; // Working space. 1d array of size 2*maxncv.
