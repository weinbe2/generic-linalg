...
C_SOURCES =  generic_cg.cpp generic_cr.cpp generic_bicgstab.cpp generic_bicgstab_l.cpp generic_gcr.cpp generic_gmres.cpp generic_gelim.cpp generic_sor.cpp generic_minres.cpp generic_cg_precond.cpp generic_cg_flex_precond.cpp generic_gcr_var_precond.cpp generic_bicgstab_precond.cpp generic_poweriter.cpp generic_precond.cpp generic_inverter.cpp
C_OBJS    = generic_bicgstab.o generic_bicgstab_l.o generic_cg.o generic_cr.o generic_gcr.o generic_gmres.o generic_gelim.o generic_sor.o generic_minres.o generic_cg_precond.o generic_cg_flex_precond.o generic_gcr_var_precond.o generic_bicgstab_precond.o generic_poweriter.o generic_precond.o generic_inverter.o
