...
inversion_info minv_vector_cg_m(double **phi, double *phi0, int n_shift, int size, int max_iter, double eps, double* shifts, void (*matrix_vector)(double*,double*,void*), void* extra_info, inversion_verbose_struct* verbosity = 0);
